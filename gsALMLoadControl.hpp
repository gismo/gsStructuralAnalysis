...
template <class T>
void gsALMLoadControl<T>::defaultOptions()
{
...
template <class T>
void gsALMLoadControl<T>::getOptions()
{
...
template <class T>
void gsALMLoadControl<T>::computeLength()
{
...
template <class T>
void gsALMLoadControl<T>::computeResidual()
{
  m_resVec = m_residualFun(m_U + m_DeltaU, m_L + m_DeltaL, m_forcing);
}

template <class T>
void gsALMLoadControl<T>::computeResidualNorms()
{
...
template <class T>
void gsALMLoadControl<T>::factorizeMatrix(const gsSparseMatrix<T> & M)
{
...
template <class T>
gsVector<T> gsALMLoadControl<T>::solveSystem(const gsVector<T> & F)
{
  if (m_solverType==solver::LDLT)
...
template <class T>
void gsALMLoadControl<T>::computeJacobian(gsVector<T> U)
{
  // Compute Jacobian
...
template <class T>
void gsALMLoadControl<T>::computeJacobian()
{
  // Compute Jacobian
  this->computeJacobian(m_U + m_DeltaU);
}

template <class T> void gsALMLoadControl<T>::computeUbar() { m_deltaUbar = this->solveSystem(-m_resVec); }
template <class T> void gsALMLoadControl<T>::computeUt()   { m_deltaUt = this->solveSystem(m_forcing); }

template <class T>
void gsALMLoadControl<T>::step()
{
...
// ------------------------------------------------------------------------------------------------------------
template <class T>
void gsALMLoadControl<T>::computeSingularPoint(T singTol, index_t kmax, gsVector<T> U, T L, T tolE, T tolB, bool switchBranch, bool jacobian)
{
...
template <class T>
void gsALMLoadControl<T>::computeSingularPoint(gsVector<T> U, T L, T tolE, T tolB, bool switchBranch, bool jacobian)
{ this->computeSingularPoint(1e-6, 5, U, L, tolE, tolB, switchBranch,jacobian); }

// template <class T>
// void gsALMLoadControl<T>::computeSingularPoint(gsVector<T> U, T L, T tolE, bool switchBranch)
// { this->computeSingularPoint(1e-6, 5, U, L, tolE, 0, switchBranch); }

// template <class T>
// void gsALMLoadControl<T>::computeSingularPoint(T singTol, index_t kmax, gsVector<T> U, T L, T tolE, bool switchBranch)
// { this->computeSingularPoint(singTol, kmax, U, L, tolE, 0, switchBranch); }

template <class T>
void gsALMLoadControl<T>::computeSingularPoint(T singTol, index_t kmax, T tolE, T tolB, bool switchBranch, bool jacobian)
{ this->computeSingularPoint(singTol, kmax, m_U, m_L, tolE, tolB, switchBranch,jacobian); }

// template <class T>
// void gsALMLoadControl<T>::computeSingularPoint(T singTol, index_t kmax, T tolE, bool switchBranch)
// { this->computeSingularPoint(singTol, kmax, m_U, m_L, tolE, 0, switchBranch); }

// template <class T>
// void gsALMLoadControl<T>::computeSingularPoint(T tolE, bool switchBranch)
// { this->computeSingularPoint(1e-6, 5, m_U, m_L, tolE, 0, switchBranch); }

// template <class T>
// void gsALMLoadControl<T>::computeSingularPoint(T tolE, T tolB, bool switchBranch)
// { this->computeSingularPoint(1e-6, 5, m_U, m_L, tolE, tolB, switchBranch); }

// ADD POINT FROM WHICH TO TEST
template <class T>
bool gsALMLoadControl<T>::testSingularPoint(T tol, index_t kmax, bool jacobian)
{
...
template <class T>
void gsALMLoadControl<T>::computeStability(gsVector<T> x, bool jacobian)
{
...
template <class T>
index_t gsALMLoadControl<T>::stability()
{
  index_t tmp = 1;
  if (m_indicator < 0)
    tmp =  -1;
...
template <class T>
index_t gsALMLoadControl<T>::stability(gsVector<T> x, bool jacobian)
{
...
template <class T>
bool gsALMLoadControl<T>::stabilityChange()
{
...
template <class T>
void gsALMLoadControl<T>::extendedSystemSolve(gsVector<T> U, T L, T tol)
{
  m_U = U;
  m_L = L;
...
template <class T>
void gsALMLoadControl<T>::extendedSystemIteration()
{
  m_resVec = m_residualFun(m_U+m_DeltaU, m_L+m_DeltaL, m_forcing);
  this->computeJacobian(m_U+m_DeltaU);
...
template <class T>
index_t gsALMLoadControl<T>::bisectionObjectiveFunction(const gsVector<T> & x, bool jacobian)
{
  this->computeStability(x,jacobian);
...
template <class T>
T gsALMLoadControl<T>::bisectionTerminationFunction(const gsVector<T> & x, bool jacobian)
{
  this->computeStability(x,jacobian);
...
template <class T>
void gsALMLoadControl<T>::bisectionSolve(gsVector<T> U, T L, T tol)
{
  m_U = U;
  m_L = L;
...
template <class T>
void gsALMLoadControl<T>::switchBranch()
{
  m_V.normalize();
...
template <class T>
void gsALMLoadControl<T>::initOutputExtended()
{
  gsInfo<<"\t";
  gsInfo<<std::setw(4)<<std::left<<"It.";
  gsInfo<<std::setw(17)<<std::left<<"Res. F";
...
template <class T>
void gsALMLoadControl<T>::stepOutputExtended()
{
  gsInfo<<"\t";
  gsInfo<<std::setw(4)<<std::left<<m_numIterations;
  gsInfo<<std::setw(17)<<std::left<<m_residueF;
