...
public:
    ...
    ///
    gsHierarchicalALM( gsALMBase<T> * ALM )
    :
    m_ALM(ALM),
    m_hierarchy()
    {
    ...
    ///
    gsHierarchicalALM( gsALMBase<T> * ALM, const std::vector<T> times, const std::vector<solution_t> solutions )
    :
    m_ALM(ALM),
    m_times(times),
...
// #include GISMO_HPP_HEADER(gsHierarchicalALM.hpp)
// #endif