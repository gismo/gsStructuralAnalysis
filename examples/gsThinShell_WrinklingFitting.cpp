...
int main (int argc, char** argv)
{
    ...
    */
    ...
    if (testCase == 2 || testCase == 3)
    {
      ...
      dirname = dirname + "/FullSheet_-r" + std::to_string(numHref) + "-R" + std::to_string(numHrefL) + "-e" + std::to_string(numElevate) + "-E" + std::to_string(numElevateL) + "-M" + std::to_string(material) + "-c" + std::to_string(Compressibility);
      if (THB)
    ...
    else if (testCase == 4 || testCase == 5)
    {
      ...
      dirname = dirname + "/HalfSheet_-r" + std::to_string(numHref) + "-R" + std::to_string(numHrefL) + "-e" + std::to_string(numElevate) + "-E" + std::to_string(numElevateL) + "-M" + std::to_string(material) + "-c" + std::to_string(Compressibility);
      if (THB)
        dirname = dirname + "_THB";
      if (symmetry)
        dirname = dirname + "_symmetryBC";
    ...
    else if (testCase == 6 || testCase == 7)
    {
      ...
      dirname = dirname + "/QuarterSheet_-r" + std::to_string(numHref) + "-R" + std::to_string(numHrefL) + "-e" + std::to_string(numElevate) + "-E" + std::to_string(numElevateL) + "-M" + std::to_string(material) + "-c" + std::to_string(Compressibility);
      if (THB)
        dirname = dirname + "_THB";
      if (symmetry)
        dirname = dirname + "_symmetryBC";
    ...
    else if (testCase == 8)
    {
      ...
      dirname = dirname + "/Shear_solution_-r" + std::to_string(numHref) + "-R" + std::to_string(numHrefL) + "-e" + std::to_string(numElevate) + "-E" + std::to_string(numElevateL) + "-M" + std::to_string(material) + "-c" + std::to_string(Compressibility);
