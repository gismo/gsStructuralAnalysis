...
//    gsPiecewiseFunction<> t(mp.nPatches());
    ...
    for (index_t d = 0; d != 3; d++) {
        BCs.addCondition(0, boundary::north, condition_type::dirichlet, 0, 0, false, d);
        BCs.addCondition(0, boundary::south, condition_type::dirichlet, 0, 0, false, d);
...
//    arcLength->options().setInt("AngleMethod", 1); // 0: step, 1: iteration
