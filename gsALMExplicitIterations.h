 /** @file gsALMExplicitIterations.h
...
*/
template <class T>
class gsALMExplicitIterations : public gsALMBase<T>
{
...
public:
    ...
    gsALMExplicitIterations(  std::function < gsSparseMatrix<T> ( gsVector<T> const & ) > &Jacobian,
...
#include GISMO_HPP_HEADER(gsALMExplicitIterations.hpp)
#endif
